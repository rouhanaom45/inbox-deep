...
random_click((852, 238), (1023, 424))
time.sleep(random.uniform(1.0, 1.6))

random_click((513, 527), (828, 541))
time.sleep(random.uniform(3.5, 4.6))

random_click((81, 216), (323, 502))
...
def action_one():
    random_click((497, 457), (547, 473))
    time.sleep(random.uniform(1.0, 1.3))

def action_two():
    random_click((584, 458), (632, 474))
    time.sleep(random.uniform(1.0, 1.3))
...
actions = [
    lambda: (random_click((511, 475), (612, 491)), time.sleep(random.uniform(1.0, 1.3))),
    lambda: (random_click((650, 475), (742, 488)), time.sleep(random.uniform(1.0, 1.3))),
    lambda: (random_click((510, 517), (591, 532)), time.sleep(random.uniform(1.0, 1.3))),
    lambda: (random_click((631, 520), (724, 532)), time.sleep(random.uniform(1.0, 1.3))),
]

# Randomly execute one of them
random.choice(actions)()

random_click((520, 587), (819, 600))
time.sleep(random.uniform(3.5, 4.6))

random_click((36, 311), (162, 536))
time.sleep(random.uniform(1.0, 1.3))
